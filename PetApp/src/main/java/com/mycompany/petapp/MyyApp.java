...
//May 21 2021
//Week 2 Pet names
//Milepost 4 adding way to save and load file of database
//Milepost 4.2 or 5. Add error handling which I have been doing all along
//Add limits to age of pets and size of database as well.
...
public class MyyApp {
    ...
    public static void loadPets(ArrayList<MyyApp> petRecords) {
        ...
        try {
            ...
            while (input.hasNextLine()) {
                ...
                petRecords.add(new MyyApp(arrayLine[0], Integer.parseInt(arrayLine[1])));
            }
            input.close();
    ...
    public static void savePets(ArrayList<MyyApp> petRecords) {
        try {
    ...
    public static void searchPetsByName(ArrayList<MyyApp> petRecords) {
        Scanner reader = new Scanner(System.in);
        System.out.println("Type the pet's name and press ENTER: ");
    ...
    public static void searchPetsByAge(ArrayList<MyyApp> petRecords) {
        Scanner reader = new Scanner(System.in);
